...
public class Productadapter extends ListAdapter<Product, Productadapter.EqViewHolder> {
    ...
    @NonNull
    @Override
    public Productadapter.EqViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Productadapter.EqViewHolder holder, int position) {
